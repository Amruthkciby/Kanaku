...
// ── mobile: owner signed in ─────────────────────────────────────────
{
  ...
  const hasBusinessTab = await page.locator("nav >> text=Business").count();
